...
console.log(alternateRicks.split(",").length);
...
console.log(grandson.replace(grandson.slice(5, 13), ""));
console.log(grandson.includes("Antoine") && "Morty Smith");
// Q5
// Decode and console. the secret!
// To do so, you will need to remove all of the notCode words.

console.log(wordsToExclude);
// Q6 (challenge)
...
const onlyRealEnemies = enemies
  .split(", ")
  .filter(enemy => enemy !== "Scary Terry");

console.log(onlyRealEnemies);
